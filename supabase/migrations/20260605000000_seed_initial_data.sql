-- Phase 4: Load Initial Data for RH Cursos Demo
-- Executa após as migrations de schema
...
values
  ('inst-1', 'Mariana Teles', 'mariana.teles@rhcursos.com', '(61) 98111-2001', 'Especialista em rotinas trabalhistas, cálculo de encargos e revisão de processos de DP.', 'Folha de pagamento', 4.90, 'Ativo'),
  ('inst-2', 'Gustavo Ribeiro', 'gustavo.ribeiro@rhcursos.com', '(61) 98111-2002', 'Atua com implantação, auditoria e correção de eventos do eSocial em equipes públicas e privadas.', 'eSocial', 4.80, 'Ativo'),
  ('inst-3', 'Lívia Cardoso', 'livia.cardoso@rhcursos.com', '(61) 98111-2003', 'Consultora em contratação pública, fiscalização e gestão de riscos em processos administrativos.', 'Licitações e contratos', 4.90, 'Ativo'),
  ('inst-4', 'Ricardo Braga', 'ricardo.braga@rhcursos.com', '(61) 98111-2004', 'Instrutor com foco em governança, inexigibilidade e melhoria de processos no setor público.', 'Gestão pública', 4.70, 'Ativo'),
  ('inst-5', 'Patrícia Nogueira', 'patricia.nogueira@rhcursos.com', '(61) 98111-2005', 'Facilitadora em liderança humanizada, prevenção de conflitos e desenvolvimento de equipes.', 'Liderança', 4.90, 'Ativo'),
  ('inst-6', 'Felipe Azevedo', 'felipe.azevedo@rhcursos.com', '(61) 98111-2006', 'Atua com comunicação não violenta, relações interpessoais e ambientes de trabalho seguros.', 'Comunicação', 4.80, 'Ativo'),
  ('inst-7', 'Bianca Salles', 'bianca.salles@rhcursos.com', '(61) 98111-2007', 'Especialista em dashboards, visualização de dados e indicadores aplicados a RH e áreas administrativas.', 'Power BI', 4.90, 'Ativo'),
  ('inst-8', 'Henrique Monteiro', 'henrique.monteiro@rhcursos.com', '(61) 98111-2008', 'Consultor em produtividade, relatórios gerenciais e automação de rotinas administrativas.', 'Indicadores e relatórios', 4.80, 'Ativo')
on conflict (id) do update set
  nome = excluded.nome,
