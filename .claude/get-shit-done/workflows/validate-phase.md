...
```
Task(
  prompt="Read /Users/pedroaugusto/Documents/Site RH Cursos/site-rh-cursos/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/pedroaugusto/Documents/Site RH Cursos/site-rh-cursos/.claude/get-shit-done/templates/VALIDATION.md`
