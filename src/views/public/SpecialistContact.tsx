    ...
    <>
      <section className="bg-deep-navy py-20 text-white">
        <div className="ea-container">
          ...
          <h1 className="mt-4 max-w-3xl text-white">Fale com um especialista da RH Cursos.</h1>
      ...
      <section className="page-section">
        <div className="ea-container grid gap-8 xl:grid-cols-[0.9fr_1.1fr] xl:items-start">
          <div className="space-y-6">
            <SectionTitle
              eyebrow="Por que falar conosco"
              title="Diagnóstico antes da solução."
              description="Nosso atendimento começa entendendo o contexto do seu departamento para recomendar o caminho certo."
            />
            <div className="grid gap-4">
              {guarantees.map((item) => {
                ...
                return (
                  <Card key={item.title} className="border-outline-variant bg-white/95">
            ...
            <Card className="overflow-hidden border-outline-variant bg-deep-navy text-white">
              <CardContent className="space-y-3 p-6">
                ...
                <p className="text-lg font-semibold leading-7">
                  Empresas, prefeituras, governos, autarquias e câmaras confiam no nosso método.
                </p>
                <p className="text-sm leading-6 text-white/75">
                  Um especialista retorna com diagnóstico, formato recomendado e próximos passos.
                </p>
              </CardContent>
            </Card>
          </div>

          <Card className="border-outline-variant bg-white/95 shadow-card" data-testid="ui-specialist-form">
