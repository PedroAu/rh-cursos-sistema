  ...
  return (
    ...
    >
      <button
        ...
        onClick={open}
        className="inline-flex h-11 w-11 items-center justify-center rounded-tk-button border border-[var(--tk-black-8)] bg-tk-surface text-tk-brand transition hover:bg-[var(--tk-black-5)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tk-focus focus-visible:ring-offset-2"
      >
        <Menu className="h-5 w-5" aria-hidden="true" />
      </button>

      <DialogContent className="left-auto right-0 top-0 h-screen w-[min(24rem,100vw)] translate-x-0 translate-y-0 rounded-none border-l border-rh-paper-line bg-rh-paper-a p-0">
        <DialogHeader className="border-b border-rh-paper-line px-6 py-5">
        ...
        <div className="grid gap-3 border-t border-rh-paper-line px-6 py-5">
          ...
          <Button
            asChild
            variant="secondary"
            className="border-rh-paper-line bg-white text-tk-brand hover:bg-rh-paper-b"
            onClick={close}
          >
          ...
          <Button
            asChild
            variant="ghost"
            className="text-tk-ink hover:bg-white/70"
            onClick={close}
          >
