      ...
      <div>
        <Card className="group h-full overflow-hidden border-outline-variant bg-white/95 hover:-translate-y-1 hover:border-accent hover:shadow-card">
          <div className={`relative overflow-hidden ${compact ? "aspect-[16/10]" : "aspect-video"}`}>
            ...
            />
            <div className="absolute left-4 top-4 rounded bg-white/96 px-3 py-1.5 text-label font-bold uppercase tracking-[0.12em] text-primary shadow-sm">
              {course.pathName}
            </div>
          </div>
          ...
          <CardContent className="space-y-6 p-6">
            <div className="space-y-3">
              <h3 className="line-clamp-2 text-card font-bold text-primary">{course.title}</h3>
