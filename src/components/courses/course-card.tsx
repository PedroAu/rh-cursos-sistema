...
export function CourseCard({ course, nextClass, compact = false }: CourseCardProps) {
  ...
  const cardBody = (
    <Card className="group h-full overflow-hidden border-[#d7dee5] bg-white shadow-[0_10px_24px_rgba(0,67,100,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_34px_rgba(0,67,100,0.14)]">
