...
export function H1({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return <h1 className={cn("font-tk-display text-display-hero font-bold leading-tight text-tk-ink", className)} {...props} />;
}

export function H2({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return <h2 className={cn("font-tk-display text-display-large font-bold leading-tight text-tk-ink", className)} {...props} />;
}

export function H3({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return <h3 className={cn("font-tk-display text-section-heading font-bold leading-snug text-tk-ink", className)} {...props} />;
}
