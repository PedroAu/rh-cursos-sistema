...
## Acceptance Criteria
- [ ] Cabeçalho “Instrutores”, resumo e “Novo instrutor” seguem `Admin — Instrutores`.
- [ ] Desktop usa grade de cards com identidade, área, status, número de cursos/turmas e ação; mobile usa uma coluna.
- [ ] Contagens são derivadas de cursos/turmas reais e o CRUD atual permanece acessível.
- [ ] Cards usam tokens Trust Keith e semântica acessível.
- [ ] Testes cobrem cards, contagens, ação e breakpoints.
