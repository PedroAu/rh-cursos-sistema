...
- [x] Decidir G1 (Fraunces) e G4 (fontes Google) com plano `next/font` (AC: 2, 5)
...
- 2026-07-02 - @aiox-master (Orion) - ADR-014 criado: D1-D6 ratificadas; D7 resolve G1/G4 (next/font; Fraunces em duas trilhas, decisao do usuario sinalizada); D8 estrutura de componentes; D9 admin re-skin minimo. Gate documental: ACs 1-5 atendidos. Status: InProgress -> InReview.
