...
5. O inventario registra assets definitivos e temporarios: `public/images/brand/logo-horizontal.png` como logo final, `public/uploads/logoHorizontal_800X600.png`, `public/_ds/`, `public/support.js` e `.dc.html` como apoio temporario de renderizacao de referencia.
