...
- **Display**: Quincy CF (700 weight) — bold, distinctive, anchors hero sections and major headings.
...
|------|------|------|--------|-------------|---|--|
| Display Hero | Quincy CF | 60px (3.75rem) | 700 | 1.1 | -0.02em | — | Hero headlines, maximum impact |
| Display Large | Quincy CF | 44px (2.75rem) | 700 | 1.2 | -0.02em | — | Section headers, feature callouts |
| Section Heading | Quincy CF | 32px (2rem) | 700 | 1.25 | normal | — | Page section breaks |
...
- **Letter spacing stays tight at display sizes.** Quincy CF headlines are tracked normally to -0.02em, keeping them compact and impactful.
...
### Don'ts
- **Don't use Inter Bold for headlines.** Quincy CF is distinctive and brand-owned; Inter Bold looks generic. If Quincy CF is unavailable, use a serif alternative, not another sans-serif.
...
1. **Quincy CF is the headline font.** Every major heading (h1, h2, h3) must use Quincy CF weight 700. If Quincy CF is unavailable, use a bold serif; never substitute with Inter Bold.
