# Spec de fidelidade — /admin/turmas

**ID:** FIDELITY-ADMIN-TURMAS
**Tela:** Turmas
**Rota:** `/admin/turmas`
**Viewport de referência:** 1360 × 2400
**Canvas isolado:** `docs/design-system/reference/admin-turmas.html`
**Fonte:** `docs/design-system/RH Cursos Admin Dashboard.dc.html`

## Intenção

Tabela de turmas, ocupação e criação de turma.

## Regiões visuais e componentes

- Cabeçalho com criação; agenda de turmas; barras de ocupação; badges de modalidade e paginação.
...
- O canvas isolado expõe somente a tela `turmas`; navegação lateral e chrome compartilhado permanecem visíveis para preservar contexto.
