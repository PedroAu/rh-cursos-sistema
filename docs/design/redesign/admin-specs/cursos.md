# Spec de fidelidade — /admin/cursos

**ID:** FIDELITY-ADMIN-CURSOS
**Tela:** Cursos
**Rota:** `/admin/cursos`
**Viewport de referência:** 1360 × 2400
**Canvas isolado:** `docs/design-system/reference/admin-cursos.html`
**Fonte:** `docs/design-system/RH Cursos Admin Dashboard.dc.html`

## Intenção

Tabela de cursos, busca e criação de curso.

## Regiões visuais e componentes

- Cabeçalho com busca e ação primária; tabela de cursos; estado de busca vazio; paginação.
...
- O canvas isolado expõe somente a tela `cursos`; navegação lateral e chrome compartilhado permanecem visíveis para preservar contexto.
