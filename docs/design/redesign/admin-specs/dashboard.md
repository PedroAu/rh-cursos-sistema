# Spec de fidelidade — /admin

**ID:** FIDELITY-ADMIN-DASHBOARD
**Tela:** Dashboard
**Rota:** `/admin`
**Viewport de referência:** 1360 × 2400
**Canvas isolado:** `docs/design-system/reference/admin-dashboard.html`
**Fonte:** `docs/design-system/RH Cursos Admin Dashboard.dc.html`

## Intenção

Visão operacional com indicadores, atividades recentes e atalhos administrativos.
...
- O canvas isolado expõe somente a tela `dashboard`; navegação lateral e chrome compartilhado permanecem visíveis para preservar contexto.
