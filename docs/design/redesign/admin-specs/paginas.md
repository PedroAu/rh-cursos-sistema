# Spec de fidelidade — /admin/paginas

**ID:** FIDELITY-ADMIN-PAGINAS
**Tela:** Páginas
**Rota:** `/admin/paginas`
**Viewport de referência:** 1360 × 2400
**Canvas isolado:** `docs/design-system/reference/admin-paginas.html`
...
- Lista de páginas institucionais; rotas públicas; status editorial e ação de gerenciamento.
...
- O canvas isolado expõe somente a tela `paginas`; navegação lateral e chrome compartilhado permanecem visíveis para preservar contexto.
