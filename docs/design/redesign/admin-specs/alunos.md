# Spec de fidelidade — /admin/alunos

**ID:** FIDELITY-ADMIN-ALUNOS
**Tela:** Alunos
**Rota:** `/admin/alunos`
**Viewport de referência:** 1360 × 2400
**Canvas isolado:** `docs/design-system/reference/admin-alunos.html`
**Fonte:** `docs/design-system/RH Cursos Admin Dashboard.dc.html`

## Intenção

Busca e gestão de alunos.

## Regiões visuais e componentes

- Cabeçalho com busca; KPIs; tabela com avatar e organização; estado vazio e paginação.
...
- O canvas isolado expõe somente a tela `alunos`; navegação lateral e chrome compartilhado permanecem visíveis para preservar contexto.
