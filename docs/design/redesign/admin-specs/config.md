# Spec de fidelidade — /admin/configuracoes

**ID:** FIDELITY-ADMIN-CONFIG
**Tela:** Configurações
**Rota:** `/admin/configuracoes`
**Viewport de referência:** 1360 × 2400
**Canvas isolado:** `docs/design-system/reference/admin-config.html`
**Fonte:** `docs/design-system/RH Cursos Admin Dashboard.dc.html`

## Intenção

Preferências institucionais e alertas operacionais.

## Regiões visuais e componentes

- Dados institucionais; toggles de alertas; contatos comerciais; atividade recente e preferências.
...
- O canvas isolado expõe somente a tela `config`; navegação lateral e chrome compartilhado permanecem visíveis para preservar contexto.
