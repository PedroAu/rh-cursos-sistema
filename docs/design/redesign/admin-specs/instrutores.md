# Spec de fidelidade — /admin/instrutores

**ID:** FIDELITY-ADMIN-INSTRUTORES
**Tela:** Instrutores
**Rota:** `/admin/instrutores`
**Viewport de referência:** 1360 × 2400
**Canvas isolado:** `docs/design-system/reference/admin-instrutores.html`
**Fonte:** `docs/design-system/RH Cursos Admin Dashboard.dc.html`

## Intenção

Lista de instrutores e disponibilidade.

## Regiões visuais e componentes

- Cabeçalho com criação; tabela de instrutores; disponibilidade; avatar e ações de detalhe.
...
- O canvas isolado expõe somente a tela `instrutores`; navegação lateral e chrome compartilhado permanecem visíveis para preservar contexto.
