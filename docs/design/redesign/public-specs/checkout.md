# Spec de fidelidade — /cursos/[slug]/checkout

**ID:** FIDELITY-PUBLIC-CHECKOUT
**Rota:** `/cursos/[slug]/checkout`
**Viewport de referência:** 1180 × 2400
**Canvas fonte:** `docs/design-system/RH Cursos Checkout.dc.html`
**Referência autocontida:** `docs/design-system/reference/checkout.html`

## Intenção

Checkout com turma, dados do comprador e confirmação.
