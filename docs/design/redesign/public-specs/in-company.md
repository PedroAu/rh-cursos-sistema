# Spec de fidelidade — /in-company

**ID:** FIDELITY-PUBLIC-IN-COMPANY
**Rota:** `/in-company`
**Viewport de referência:** 1180 × 2400
**Canvas fonte:** `docs/design-system/RH Cursos In-company.dc.html`
**Referência autocontida:** `docs/design-system/reference/in-company.html`

## Intenção

Solicitação de treinamento corporativo.
