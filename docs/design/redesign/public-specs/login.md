# Spec de fidelidade — /login

**ID:** FIDELITY-PUBLIC-LOGIN
**Rota:** `/login`
**Viewport de referência:** 1180 × 2400
**Canvas fonte:** `docs/design-system/RH Cursos Login.dc.html`
**Referência autocontida:** `docs/design-system/reference/login.html`

## Intenção

Autenticação pública com retorno para a rota solicitada.
