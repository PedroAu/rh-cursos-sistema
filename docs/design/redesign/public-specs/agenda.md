# Spec de fidelidade — /agenda

**ID:** FIDELITY-PUBLIC-AGENDA
**Rota:** `/agenda`
**Viewport de referência:** 1180 × 2400
**Canvas fonte:** `docs/design-system/Agenda export.dc.html`
**Referência autocontida:** `docs/design-system/reference/agenda.html`

## Intenção

Agenda pública com datas, modalidades e disponibilidade.
