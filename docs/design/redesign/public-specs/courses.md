# Spec de fidelidade — /cursos

**ID:** FIDELITY-PUBLIC-COURSES
**Rota:** `/cursos`
**Viewport de referência:** 1180 × 2400
**Canvas fonte:** `docs/design-system/RH Cursos Catálogo.dc.html`
**Referência autocontida:** `docs/design-system/reference/courses.html`

## Intenção

Catálogo filtrável com cursos e turmas publicados.
