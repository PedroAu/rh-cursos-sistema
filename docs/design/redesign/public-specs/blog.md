# Spec de fidelidade — /blog

**ID:** FIDELITY-PUBLIC-BLOG
**Rota:** `/blog`
**Viewport de referência:** 1180 × 2400
**Canvas fonte:** `docs/design-system/RH Cursos Blog.dc.html`
**Referência autocontida:** `docs/design-system/reference/blog.html`

## Intenção

Lista pública de artigos e categorias.
